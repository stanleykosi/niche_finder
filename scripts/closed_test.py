...
REQUIRED_FILES = [
    ...
    "apps/api/app/db/models.py", "apps/api/app/db/session.py", "apps/api/app/db/schema_gate.py", "apps/api/alembic/versions/0001_initial.py", "apps/api/alembic/versions/0002_media_features.py", "apps/api/alembic/versions/0003_evidence_bound_synthesis.py", "apps/api/alembic/versions/0004_runtime_artifacts.py", "apps/api/alembic/versions/0005_shared_quota_ledger.py", "apps/api/alembic/versions/0006_bigint_public_counters.py", "apps/api/alembic/versions/0007_media_bridge_assessment.py", "apps/api/alembic/versions/0008_snapshot_run_identity.py", "apps/api/alembic/versions/0009_comment_sample_identity.py",
    ...
    "apps/api/app/storage/artifacts.py", "apps/api/app/services/jobs.py", "apps/api/app/services/health.py", "apps/api/app/services/storage_status.py", "workers/research/worker.py", "scripts/cleanup_runtime.py",
    ...
    "apps/api/tests/test_browser_paths.py", "apps/api/tests/test_jobs.py", "apps/api/tests/test_health.py", "apps/api/tests/test_sqlite_runtime.py", "apps/api/tests/test_deployment_config.py",
