...
class Settings(BaseModel):
    ...
    openrouter_request_timeout_seconds: float = Field(default=900.0, ge=5, le=1800)
    ...
    def from_env(cls, environ: dict[str, str] | None = None) -> "Settings":
        ...
        values: dict[str, Any] = {
            ...
            "openrouter_request_timeout_seconds": env.get("OPENROUTER_REQUEST_TIMEOUT_SECONDS", 900),
